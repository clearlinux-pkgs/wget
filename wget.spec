...
Source0  : https://mirrors.kernel.org/gnu/wget/wget-1.20.tar.gz
Source99 : https://mirrors.kernel.org/gnu/wget/wget-1.20.tar.gz.sig
...
export LANG=C
export SOURCE_DATE_EPOCH=1543768289
