...
Source0  : https://mirrors.kernel.org/gnu/wget/wget-1.25.0.tar.gz
Source1  : https://mirrors.kernel.org/gnu/wget/wget-1.25.0.tar.gz.sig
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1731448255
